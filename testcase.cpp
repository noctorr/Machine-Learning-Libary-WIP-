...
int main()
{
  ...
  IEE_754_FLOAT testcase3_double_4(1.0);
  IEE_754_FLOAT testcase3_double_5(0.5);

  double output_3 = testcase3_double_4 + testcase3_double_5;
  // OUTPUT IS INF
  /*
  TODO: I HAVE THOUGHT OF A WAY TO BATTLE THE TWO TEST CASES WHERE I LOOK FOR SPECIFIC PATTERNS IN THE EXPONENT BITS AS MY CALCULATION FOR THE MANTISSA IS RIGHT BUT THE EXPONENT IS VARIES
  ON THE NUMBER.
  */
  return 0;
}
